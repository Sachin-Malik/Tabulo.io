...
function DropDown({checkBoxClicked,checkBoxes}) {
    return (
        ...
        <a className="btn white-text filter-bg dropdown-toggle" href="#top" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Meals Filter
        </a>
